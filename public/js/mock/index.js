  ...
  attention: [
    {
      level: "ok",
      title: "系统运行正常",
      body: "索引与存储均处于健康状态，最近 24 小时无异常。",
    },
    {
      level: "warning",
      title: "回收站提醒",
      body: "回收站中有 6 个项目，建议定期清理以释放空间。",
    },
  ],
};
