export function createPageRenderers(deps) {
  ...
  function renderAdminActiveTab(admin, activeTab) {
    switch (activeTab) {
      ...
      case "system":
        return renderSystemStatusSection(admin);
      case "notifications":
        return renderAdminNotificationsSection(admin);
      case "storage":
        return renderStorageSection(admin);
      case "logs":
        return renderAdminLogsSection(admin);
      case "paths":
        return renderPathManagementSection(admin);
      case "webhooks":
        return renderWebhookSection(admin);
      case "maintenance":
        return renderAdminMaintenanceSection(admin);
      case "shares":
        return renderAdminSharesSection(admin);
      default:
        return "";
    }
  }
